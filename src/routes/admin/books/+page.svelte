...
<svelte:head>
	<title>{pageTitle('Books — Admin')}</title>
</svelte:head>
...
<div class="space-y-6">
	...
	{#if showUrlForm}
		<Card.Root>
			<Card.Header>
				...
				<Card.Description>
					Paste a Hardcover or Goodreads book URL. It'll be queued for resolution by the worker.
				</Card.Description>
			</Card.Header>
			<Card.Content>
				<form
	...
	<UnmatchedSources sources={data.unresolvedSources} subjectLabel="book" />
